...
const RestroCard = (props) => {
  ...
  return (
    <div className="p-0 m-0 ">
      <div className="mt-7 bg-white shadow-lg hover:cursor-pointer hover:scale-95 transition ease-in-out duration-300 rounded-lg overflow-hidden w-72">
        <div
        ...
        >
          <div className="absolute bg-gray-100 px-2 py-1 text-xs rounded bottom-3 right-3">
            {deliveryTime} mins
          </div>
